...
public class SignThree extends JFrame implements ActionListener {
	...
	public SignThree(String formNum) {
		this.formno=formNum;
	...
	public void actionPerformed(ActionEvent ae) {
       String atype=null;
       if(r1.isSelected()) {
    	   atype="Saving Acccount";
       }
       else if(r2.isSelected()) {
    	   atype="Fixed Deposite Acccount";
       }
       else if(r3.isSelected()) {
    	   atype="Current Acccount";
       }
       else if(r4.isSelected()) {
    	   atype="Recurring Acccount";
       }
       Random random=new Random();
       //number generator Logic 
       long num1=(random.nextLong()%90000000L)+5040936000000000L;
       String cardNumber=""+Math.abs(num1);
